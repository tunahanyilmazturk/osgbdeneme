...
>(({ className, variant = "default", ...props }, ref) => {
  const variants = {
    ...
    outlined: "rounded-xl border-2 bg-transparent text-card-foreground",
    gradient: "rounded-xl border-0 bg-gradient-to-br from-card to-muted text-card-foreground",
  };

  return (
    <div
      ref={ref}
      className={cn(variants[variant], "transition-all duration-300 hover:shadow-md", className)}
      {...props}
    />
  );
});
